...
<%
   ...
   if (nowPageBlock > 1) {
      ...
      out.print("<a class=\"aTag\" href=\"" + contextPath + "/board/cat/" + categoryId + "/" + (startPage - 1)
            + "\"   aria-label=\"Previous\">");
      out.print("◀</a>");
      out.println("</li>");
   }
   for (int i = startPage; i <= endPage; i++) {
      ...
      out.print("<a   href=\"" + contextPath + "/empBoard/cat/" + categoryId + "/" + (i) + "\">");
      out.print(i);
      out.print("</a>");
      out.println("</li>");
   }
   if (nowPageBlock < totalPageBlock) {
      out.print("<li class=\"active\">");
      out.print("<a class=\"aTag\"  href=\"" + contextPath + "/empBoard/cat/" + categoryId + "/" + (endPage + 1)
            + "\"   aria-label=\"Next\">");
      out.print("▶</a>");
      out.println("</li>");
   }
